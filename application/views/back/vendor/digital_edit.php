...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'index.php/vendor/digital/update/' . $row['product_id'], array(
...
<script>
	...
	function video_preview(v_link){
		...
		$('#vl').val(video_link);
		$('#video_preview').load('<?php echo base_url();?>index.php/vendor/digital/video_preview/'+site+'/'+video_link);
	}
...
<script type="text/javascript">
    ...
    function get_cat(id){
        $('#brand').html('');
        $('#sub').hide('slow');
        ajax_load(base_url+'index.php/vendor/digital/sub_by_cat/'+id,'sub_cat','other');
    }
