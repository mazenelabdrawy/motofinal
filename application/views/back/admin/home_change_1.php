            ...
            <div class="tab-content">
                ...
                <div id="tabb-7" class="tab-pane fade">
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
                           	<?php
								echo form_open(base_url() . 'index.php/admin/ui_settings/ui_home/home_blog/', array(
									'class' => 'form-horizontal',
									'method' => 'post',
									'id' => '',
									'enctype' => 'multipart/form-data'
                ...
                <div id="tabb-9" class="tab-pane fade">
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
                        	<?php
								echo form_open(base_url() . 'index.php/admin/ui_settings/ui_home/home_brand/', array(
									'class' => 'form-horizontal',
									'method' => 'post',
									'id' => '',
									'enctype' => 'multipart/form-data'
